...
let Inloggad = () => {
  ...
  let addTodo = () => {
    ...
    todos.includes(newTodo)
      ...
      setIsVibrating(true); // Starta vibration
      setTimeout(() => setIsVibrating(false), 1000); // Sluta vibration efter 1 sekund
  ...
  return (
    <>
      ...
      <br />
      <div
          className={`attGöraDiv ${isVibrating ? "vibrate-element" : "vibrate-static"}`}
            ...
            return (
              <div key={i}>
                <li key={i}>
                  ...
                  <button id="knapp" onClick={() => deleteTodo(i)}>
                    Delete
                  </button>
                </li>
              </div>
